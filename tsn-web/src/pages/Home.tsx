...
const Home: React.FC = () => {
  ...
  return (
    <>
      ...
      <section id="services" className="min-h-screen bg-gray-900 text-white flex items-center justify-center">
        <h2 className="text-4xl">Our Services</h2>
      </section>

      <section id="resources" className="min-h-screen bg-black text-white flex items-center justify-center">
        <h2 className="text-4xl">Resources</h2>
      </section>

      <section id="faq" className="min-h-screen bg-gray-900 text-white flex items-center justify-center">
